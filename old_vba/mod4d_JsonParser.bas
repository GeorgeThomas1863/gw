...
''''''''''''
'
' STOLEN SHAMELESSLY FROM URL: https://github.com/VBA-tools/VBA-JSON
'
' (if dude ever asks for money and I'm not around, please give it to him [been using below code for years])
''''''''''''
...
Public Function ParseJson(ByVal jsonString As String) As Object
    Dim json_Index As Long, msg As String
    json_Index = 1
    ...
    Case Else
        ...
        'Err.Raise 10001, "ParseJson", json_ParseErrorMessage(jsonString, json_Index, "Expecting '{' or '['")
